...
class SeriesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Series
        fields = (
            'id', 'series_name', 'series_poster', 'description', 'trailer_link',
            'aired', 'avg_rating', 'production_company', 'genres', 'languages',
            'gallerys', 'casts'
        )
        extra_kwargs = {
            'id': {
    ...
    def update(self, instance, validated_data):
        ...
        instance = super(SeriesSerializer, self).update(
